...
<div class="bg-gradient-to-r from-pink-50 to-orange-50 rounded-xl p-8 mb-10 shadow-inner">
    <div class="text-center mb-6">
        <h1 class="text-5xl font-extrabold text-gray-800 mb-2 tracking-tight">Hidden Fates</h1>
        <p class="text-lg text-gray-600">Famosa por sus cartas brillantes, incluyendo versiones shiny de Pokémon populares.</p>
    </div>
    <div class="flex justify-center">
        <img src="https://images.pokemontcg.io/sm115/logo.png" alt="Hidden Fates"
             class="w-64 h-64 object-contain drop-shadow-md hover:scale-105 transition-transform duration-300">
    </div>

    <p class="text-gray-600">Total de cartas: 163<br>Lanzamiento: Agosto 2019</p>
    ...
    <div class="flex justify-between items-center mt-8">
        @if ($currentPage > 1)
            <a href="{{ route('colecciones.hidden-fates', ['page' => $currentPage - 1]) }}" class="bg-pink-300 px-4 py-2 rounded">
                ← Anterior
            </a>
        @else
            <span></span>
